...
public class AddPassengerDetails extends JFrame implements ActionListener {
    ...
    public AddPassengerDetails() {
        ...
        ImageIcon image = new ImageIcon("src/airlinemanagementsystem/icons/emp.png");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (name.isEmpty() || nationality.isEmpty() || phone.isEmpty() || address.isEmpty() || nid.isEmpty() || gender == null) {
            JOptionPane.showMessageDialog(null, "Please fill all fields including gender");
            return;
        }
